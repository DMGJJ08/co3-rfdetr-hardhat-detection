...
![Predictions](predictions_viz.png)

### Per-Class Metrics
![Per-Class Table](per_class_table.png)
...
3. File → Upload notebook → choose the downloaded file
4. Set runtime to T4 GPU → Run all cells

> Open `CO3_1_RF_DETR_Hard_Hat_with_outputs.ipynb` to view full results without running the code.
